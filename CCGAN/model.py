...
class CCGAN(object):
    ...
    def __init__(self, num_features, num_speakers, discriminator = discriminator, generator = generator_gatedcnn, mode = 'train', log_dir = './result/summary'):
    ...
    def save(self, directory, filename):#ckpt
