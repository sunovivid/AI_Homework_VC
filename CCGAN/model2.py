...
class CCGAN(object):
    ...
    def build_model(self):
        ...
        self.generation_B_identity = self.generator(inputs = self.input_B_real, source_id = self.B_id_vector, target_id = self.B_id_vector, reuse = True, scope_name = 'generator')
